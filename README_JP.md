...
まずはダッシュボードをご覧ください。日本の測定方法は論文で説明し、公開結果は下記の手順で再計算できます。
...
詳しい定義と解釈上の注意点は、[変数定義](docs/definitions.md)、[識別戦略](docs/identification_strategy.md)、[パラメータ調整の手順](docs/calibration_protocol.md)にまとめています。
