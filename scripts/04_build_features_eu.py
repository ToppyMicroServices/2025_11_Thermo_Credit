...
def build_eu(series_prefs: dict, project_config: dict) -> None:
    ...
    try:
        ...
        try:
            ...
            bis = fred_series("QUSN628BIS")  # Placeholder: may require regional adjustment
        ...
        if not ext_df.empty:
            ext_path = os.path.join("data", "external_coupling_eu.csv")
